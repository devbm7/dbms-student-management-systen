...
def DatabaseCreate():
    cnx = connector.connect(host = 'localhost', port = 3306, user = 'root', password = 'Manav_Patel@2003')
    Cursor = cnx.cursor()
...
def TablesCreate():
    cnx = connector.connect(host = 'localhost', port = 3306, user = 'root', password = 'Manav_Patel@2003', database = 'online_exam')
    Cursor = cnx.cursor()
